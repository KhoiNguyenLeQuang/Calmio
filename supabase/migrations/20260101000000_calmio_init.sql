-- Calmio initial schema.
-- Applied with: supabase db push  (see DEPLOYMENT.md section 3a)
-- This is the canonical copy; ../../supabase-schema.sql is the same file,
-- kept at the repo root for people who prefer pasting into the SQL Editor.
